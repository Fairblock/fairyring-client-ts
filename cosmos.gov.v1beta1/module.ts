...
export { DepositParams, QueryDepositsResponse, MsgVoteWeighted, MsgVoteWeightedResponse, MsgSubmitProposalResponse, MsgSubmitProposal, QueryProposalsRequest, QueryDepositResponse, TallyParams, QueryDepositRequest, GenesisState, QueryProposalsResponse, QueryVoteResponse, QueryParamsRequest, QueryParamsResponse, QueryVotesResponse, QueryProposalRequest, QueryVoteRequest, MsgVoteEncrypted, MsgVoteEncryptedResponse, VotingParams, Proposal, TallyResult, MsgVoteResponse, MsgVote, WeightedVoteOption, QueryDepositsRequest, MsgDepositResponse, MsgDeposit, Deposit, TextProposal, Vote, QueryProposalResponse, QueryVotesRequest, QueryTallyResultResponse, QueryTallyResultRequest };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgVoteEncryptedResponse({ value }: msgVoteEncryptedResponseParams): EncodeObject {
			try {
				return { typeUrl: "/cosmos.gov.v1beta1.MsgVoteEncryptedResponse", value: MsgVoteEncryptedResponse.fromPartial( value ) }  
			} catch (e: any) {
